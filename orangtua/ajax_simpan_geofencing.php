...
if ( isset( $_POST[ 'jenis' ] ) ) {
		$sql_insert = "INSERT INTO `tb_geofencing`(`id_geofencing`, `id_user`, `nama`, `jenis`, `status`, `bentuk`) VALUES (NULL,'".$_SESSION['s_id_orangtua']."','".$_POST[ 'nama' ]."','".$_POST[ 'jenis' ]."','0','".$_POST[ 'bentuk' ]."')";
