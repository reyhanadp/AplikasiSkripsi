  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      nCloneTd.innerHTML = '<img src="../halaman_utama/lib/advanced-datatable/images/details_open.png">';
...
//      });
      ...
      $('#hidden-table-info tbody td img').live('click', function() {
        ...
        if (oTable.fnIsOpen(nTr)) {
          ...
          this.src = "../halaman_utama/lib/advanced-datatable/images/details_open.png";
          oTable.fnClose(nTr);
        } else {
          /* Open this row */
          this.src = "../halaman_utama/lib/advanced-datatable/images/details_close.png";
